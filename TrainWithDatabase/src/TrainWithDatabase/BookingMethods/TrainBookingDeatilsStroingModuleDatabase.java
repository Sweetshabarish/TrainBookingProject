...
public class TrainBookingDeatilsStroingModuleDatabase {
    ...
    static void methodForTrainBooking() throws SQLException {
        String p = "insert into USERDETAILS(Name,Location,Destination,Date,PhoneNumber,TrainNumber,PnrNumber)values('" + Name + "','" + Location + "','" + Destination + "','" + Date + "','" + PhoneNumber + "','" + TrainNumber + "','" + Pnr + "')";
